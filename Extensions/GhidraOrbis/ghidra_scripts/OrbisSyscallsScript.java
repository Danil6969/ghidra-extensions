...
// ResolveX86orX64LinuxSyscallsScript script modified for Orbis OS syscalls
 ...
 */
public class OrbisSyscallsScript extends GhidraScript {
	...
	protected void run() throws Exception {
		...
		if (!OrbisUtil.isOrbisProgram(currentProgram)) {
			popup("This script is intended for Orbis OS files");
			return;
		}

		tester = OrbisSyscallsScript::checkX64Instruction;
		syscallRegister = "RAX";
		datatypeArchiveName = "generic_clib_64";
		syscallFileName = "orbis_syscall_numbers";
